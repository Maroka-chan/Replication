...
func (c *replicationClient) Bid(ctx context.Context, in *BidSlip, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/repService.Replication/Bid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicationClient) Result(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*BidSlip, error) {
	out := new(BidSlip)
	err := c.cc.Invoke(ctx, "/repService.Replication/Result", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReplicationServer) Bid(context.Context, *BidSlip) (*Response, error) {
...
func _Replication_Bid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repService.Replication/Bid",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicationServer).Bid(ctx, req.(*BidSlip))
	}
...
func _Replication_Result_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repService.Replication/Result",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
